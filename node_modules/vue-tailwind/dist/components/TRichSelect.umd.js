...
// CONCATENATED MODULE: ./src/utils/inputOptions.ts




var inputOptions_guessOptionValue = function guessOptionValue(option, valueAttribute) {
  if (valueAttribute) {
    return get_default()(option, valueAttribute);
  }

  return get_default()(option, 'value', get_default()(option, 'id', get_default()(option, 'text')));
};

var inputOptions_guessOptionText = function guessOptionText(option, textAttribute) {
  if (textAttribute) {
    return get_default()(option, textAttribute);
  }
...
var normalizeOption = function normalizeOption(option, textAttribute, valueAttribute) {
  ...
  if (option.children) {
    ...
    return {
      value: inputOptions_guessOptionValue(option, valueAttribute),
      text: inputOptions_guessOptionText(option, textAttribute),
      children: children
    };
  }
...
var inputOptions_normalizeOptions = function normalizeOptions(options, textAttribute, valueAttribute) {
  if (!options) {
    return [];
  }
...
var InputWithOptions = base_HtmlInput.extend({
  ...
  methods: {
    normalizeOptions: function normalizeOptions(options) {
      return inputOptions_normalizeOptions(options, this.textAttribute, this.valueAttribute);
    }
  }
});
...
function () {
  ...
  TRichSelectRenderer.prototype.createOptgroup = function (optgroup) {
    ...
    }, inputOptions_guessOptionText(optgroup, this.component.textAttribute));
  };
  /**
