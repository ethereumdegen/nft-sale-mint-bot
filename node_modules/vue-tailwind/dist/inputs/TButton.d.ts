...
declare const TButton: import("vue/types/vue").ExtendedVue<{
    ...
    componentToRender: string | import("vue").VueConstructor<import("vue").default> | import("vue/types/options").AsyncComponentPromise<any, any, any, any> | import("vue/types/options").AsyncComponentFactory<any, any, any, any> | import("vue").FunctionalComponentOptions<any, import("vue/types/options").PropsDefinition<any>> | import("vue").ComponentOptions<never, any, any, any, any, Record<string, any>> | undefined;
}, {
    value: string | number;
    text: string;
    tagName: string;
